...
parser.add_argument('--compressor', default='none', metavar = 'N',
                    help='type of compression method: none, fp16, tern (default: none)')
...
if compression == hvd.Compression.tern:
    ...
    hvd.Compression.tern.compress_layer_threshold = 0
...
#data = torch.randn(args.batch_size, 3, 299, 299)
...
log('Compressor: %s' % args.compressor)
