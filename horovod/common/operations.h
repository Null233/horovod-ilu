...
// C interface indicating whether TernGrad compressor is enabled.
bool horovod_TG_used();

// C interface to enable TernGrad compressor function calls.
void horovod_enable_TG();

// C interface to disable TernGrad compressor function calls.
